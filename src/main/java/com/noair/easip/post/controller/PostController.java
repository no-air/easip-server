        ...
        return PostDetailResponse.of(
            ...
            List.of(
                PostPerHouseDetailResponse.of(
                    ...
                    List.of(
                        ScheduleDto.of("모집공고", "2025-05-07", null),
                        ScheduleDto.of("청약신청", "2025-05-12T09:00:00", "2025-05-18T24:00:00"),
                        ScheduleDto.of("예비번호 발표", "2025-05-19T17:00:00", null),
                        ScheduleDto.of("계약체결", "공실 발생시 순차적으로 연락", null)
                    ),
                    List.of(
                ...
                PostPerHouseDetailResponse.of(
                    ...
                    List.of(
                        ScheduleDto.of("모집공고", "2025-06-07", null),
                        ScheduleDto.of("청약신청", "2025-06-12T09:00:00", "2025-06-18T24:00:00"),
                        ScheduleDto.of("예비번호 발표", "2025-06-19T17:00:00", null),
                        ScheduleDto.of("계약체결", "2025-06-20T17:00:00", null)
                    ),
                    List.of(
                        RoomRentalConditionResponse.of(
                            "A타입 일반공급",
